    ...
    <section className="py-16 px-6">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-orbitron font-bold text-white mb-10">
          Best Games for <span className="text-[var(--accent-gold)]">You</span>
          ...
          {games.map((game, index) => (
            ...
            >
              ...
              <div className="p-2">
                ...
                <div className="flex justify-center items-center my-3 mb-4 gap-30">
                ...
                <div className="flex justify-center items-center gap-3">
                  <a
                    href="#"
                    className="px-4 py-2 bg-[var(--accent-gold)] text-[#051A2D] font-semibold rounded-lg shadow-md hover:bg-[#051A2D] hover:text-yellow-400 border border-yellow-400 transition"
                  >
                    Buy Now
                  </a>
